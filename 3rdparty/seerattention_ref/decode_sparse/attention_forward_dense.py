...
from ..kernels.varlen.flash_decode_varlen_left_pad_max_v2 import flash_decode_leftpad
...
def dense_flash_attention_forward(
    ...
    **kwargs,
    ...
    if query_length > 1:
        ...
        # SDPA-based causal prefill (mathematically equivalent to the original
        # flash_attn_varlen_func(causal=True); no flash_attn dependency).
